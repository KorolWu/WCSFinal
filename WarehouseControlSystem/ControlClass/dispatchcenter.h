...
private:
    ...
    void handle_out_task(TaskInfoStru &t, int station = 99);
    void handle_in_task(TaskInfoStru &t, QString frist_in_boxNum, int station = 99);
    ...
    void reduceCacheIn(int station);
};
